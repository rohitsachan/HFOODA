...
public class GuitarTester {
	public static void main(String[] args) {
		...
		if (!matchingGuitars.isEmpty()) {
			...
			System.out.println("Sorry! We don't maching Guitars for you.");
		}
	}
	...
	private static void initializeInventory(Inventory inventory) {
		...
		inventory.addGuitar("70108276", 2295.95, Builder.GIBSON, "Les Paul", Type.ELECTRIC, 9, Wood.MAHOGANY,
				Wood.MAHOGANY);
		inventory.addGuitar("82765501", 1890.95, Builder.GIBSON, "SG '61 Reissue", Type.ELECTRIC, 9, Wood.MAHOGANY,
				Wood.MAHOGANY);
		inventory.addGuitar("77023", 6275.95, Builder.MARTIN, "D-28", Type.ACOUSTIC, 9, Wood.BRAZILIAN_ROSEWOOD,
				Wood.ADIRONDACK);
		inventory.addGuitar("1092", 12995.95, Builder.OLSON, "SJ", Type.ACOUSTIC, 9, Wood.INDIAN_ROSEWOOD, Wood.CEDAR);
		inventory.addGuitar("566-62", 8999.95, Builder.RYAN, "Cathedral", Type.ACOUSTIC, 9, Wood.COCOBOLO, Wood.CEDAR);
		inventory.addGuitar("6 29584", 2100.95, Builder.PRS, "Dave Navarro Signature", Type.ELECTRIC, 9, Wood.MAHOGANY,
				Wood.MAPLE);
	}
}
